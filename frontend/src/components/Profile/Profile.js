    ...
    return (
        ...
        <div className="profile">
            ...
            <main>
                ...
                {/* 다른 탭 컨텐츠들 */}
                <div id="tab1-content" className={`tab-content ${activeTab === 'tab2' ? 'tab-content--active' : ''}`}>
                    <p>
                ...
                <div id="tab1-content" className={`tab-content ${activeTab === 'tab3' ? 'tab-content--active' : ''}`}>
                    <p>
